...
<html lang="en">
  ...
  <body>
    ...
    <main>
        ...
        <div class="top_container">
            <div class="arti_hero_bg is-flex justi_cen">
                <!-- Head photo -->
                <img class="" src="images/mooday_logo.svg" alt="A logo from mooday" width="150">
            </div>
            <!-- Content -->
            <div class="top_content">
                ...
                <a href="#" class="btn_" style="color: blue;">View Live Page</a>
            </div>
        </div>
    </section>
    ...
    <div class="is-flex justi_cen">
        <img class="c4_logo" src="images/mooday_logo2.svg" alt="A logo from Mooday">
    </div>
